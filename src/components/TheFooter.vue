<template>
  <footer class="bg-dark mt-5 py-5 fixed-bottom">
    <div class="container text-white">
      <ul class="nav justify-content-right">
        <li class="nav-item">
          <a href="#" class="nav-link px-0 text-muted"
            >Home<span class="mx-3">|</span></a
          >
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link px-0 text-muted"
            >Terms and Conditions<span class="px-3">|</span></a
          >
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link px-0 text-muted"
            >Privacy Policy<span class="px-3">|</span></a
          >
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link px-0 text-muted"
            >Collection Statement<span class="px-3">|</span></a
          >
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link px-0 text-muted"
            >Help<span class="px-3">|</span></a
          >
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link px-0 text-muted">Manage Account</a>
        </li>
      </ul>
      <p class="text-muted">
        Copyright &copy; 2021 ShowFlix. All Rights Reserved
      </p>
            ...
            <a href="#">
              ...
              >
                <defs>
                  ...
                  <clipPath id="a"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <mask
                  ...
                  <clipPath id="n"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <clipPath id="b"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <pattern
                  ...
                  <clipPath id="c"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <mask
                    maskUnits="userSpaceOnUse"
                    x="0"
                    y="0"
                  ...
                  <clipPath id="q"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <clipPath id="d"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <pattern
                    patternTransform="matrix(1 0 0 -1 0 48)"
                    patternUnits="userSpaceOnUse"
                    width="124"
                  ...
                  <clipPath id="e"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <mask
                    maskUnits="userSpaceOnUse"
                    x="0"
                    y="0"
                  ...
                  <clipPath id="t"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <clipPath id="f"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <pattern
                    patternTransform="matrix(1 0 0 -1 0 48)"
                    patternUnits="userSpaceOnUse"
                    width="124"
                  ...
                  <clipPath id="g"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <mask
                    maskUnits="userSpaceOnUse"
                    x="0"
                    y="0"
                  ...
                  <clipPath id="w"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <clipPath id="h"><path d="M0 0h124v48H0V0z" /></clipPath>
                  <pattern
                    patternTransform="matrix(1 0 0 -1 0 48)"
                    patternUnits="userSpaceOnUse"
                    width="124"
